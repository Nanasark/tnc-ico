...
export default function Hero() {
  return (
    <section className="h-full my-screen:gap-0 w-full flex flex-col md:flex-row  gap-10 lg:gap-5 md:p-5">
      <div className="w-full h-full md:w-1/2 text-center content-center md:pl-10 md:pr-10  ">
        <Text />
      </div>
